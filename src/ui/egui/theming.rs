...
pub fn egui_startup(
    ...
    user_config: Res<UserSettings>,
    bevy_clear_color: ResMut<ClearColor>,
) {
    let mut s = String::new();
    File::open(&user_config.theme)
        .unwrap()
...
pub fn configure_egui(
    egui_ctx: &egui::Context,
    colours: ColourScheme,
    mut bevy_clear_color: ResMut<ClearColor>,
) {
    bevy_clear_color.0 = Color::rgba_u8(
        colours.base.0[0],
        colours.base.0[1],
        colours.base.0[2],
        colours.base.0[3],
    ...
    egui_ctx.set_visuals(egui::Visuals {
        ...
        selection: style::Selection {
            bg_fill: (Color32::from(c.blue)).linear_multiply(if c.name == "Latte" {
                0.4
            } else {
                0.2
            }),
